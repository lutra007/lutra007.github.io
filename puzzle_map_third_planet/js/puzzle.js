...
(function() {
    // Переменные
    answers = 'северная корона,большая медведица,южный крест,золотая рыба,малый конь,райская птица,гончие псы,волосы вероники'
    music_file = 'snd/cosmo.mp3'
    final_message = 'Бортовой компьютер начинает перезагрузку!!!'
    number_of_puzzles = 8
